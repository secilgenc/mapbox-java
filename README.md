...
**Note**: Where did the Navigation SDK go? The Mapbox Navigation SDK for Android [has graduated into its own repository](https://github.com/mapbox/mapbox-navigation-android).
